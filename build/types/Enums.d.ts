 ...
 */
export declare enum SquareOption {
    Solid = 0,
    HollowThick = 1,
    HollowThin = 2
}
 ...
 */
export declare enum CircleOption {
    Solid = 0,
    HollowThick = 1,
    HalfSolid = 2,
    HalfHollow = 3,
 ...
 */
export declare enum TriangleOption {
    Solid = 0,
    Hollow = 1,
    RightAngledSolid = 2,
    RightAngledHollow = 3
 ...
 */
export declare enum ArrowOption {
    Normal = 0,
    Head = 1
}
/**
 ...
 */
export declare enum HexagonOption {
    Solid = 0,
    HollowThick = 1,
    HollowThin = 2,
    Half = 3,
 ...
 */
export declare enum AutoKillType {
    /**
